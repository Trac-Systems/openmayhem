...
| candidate `video.minimax_h3.lowvram_t2v_i2v` | Comfy workflow video+audio | ComfyUI / submitted low-VRAM H3 pack: W4A8 diffusion, INT8 video VAE, turbo LoRAs, MiniMaxH3-Easy, KJ low-VRAM nodes | Candidate only; not public until signed parts, runtime proof, admission, and paid proof pass | 48 GiB target | 16 GiB VRAM + 32 GiB RAM target | Default `4` steps; user-adjustable only to `4`, `6`, or `8`; 736x1280, 10s, 243 frames; do not use 20-step H3 settings here |
| candidate `video.minimax_h3.lowvram_r2v` | Comfy workflow reference-media video+audio | ComfyUI / submitted low-VRAM H3 R2V pack: W4A8 REF2VA, INT8 video VAE, 4-step REF2V LoRA, same custom nodes | Candidate only; not public until signed parts, runtime proof, admission, and paid proof pass | 48 GiB target | 16 GiB VRAM + 32 GiB RAM target | Submitted pack has only a 4-step R2V graph; do not advertise 6/8-step R2V until separately proven |

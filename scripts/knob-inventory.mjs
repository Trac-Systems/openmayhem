...
const contractParamDescriptions = new Map([
  ...
  ['price_min_bps', 'Price lower bound versus model reference; cannot go below 25%.'],
  ['price_max_bps', 'Price upper bound versus model reference; cannot exceed 400%.'],
  ...
  ['market_target_utilization_bps', 'Deprecated and read-only since contract v25; ignored by activity momentum pricing.'],
  ['market_ema_alpha_bps', 'Telemetry-only settled activity EMA weight; price direction compares consecutive epochs.'],
  ['market_gain_bps', 'Dampening gain toward the desired market price.'],
  ['market_max_step_bps', 'Per-epoch market price movement clamp.'],
  ['market_cold_start_min_providers', 'Deprecated and read-only since contract v25; ignored by activity momentum pricing.'],
  ['market_provider_epoch_target_au', 'Deprecated and read-only since contract v25; ignored by activity momentum pricing.'],
  ['market_max_utilization_bps', 'Deprecated and read-only since contract v25; ignored by activity momentum pricing.'],
  ['market_below_target_discount_bps', 'Deprecated and read-only since contract v25; ignored by activity momentum pricing.'],
  ['market_above_target_slope_bps', 'Deprecated and read-only since contract v25; ignored by activity momentum pricing.'],

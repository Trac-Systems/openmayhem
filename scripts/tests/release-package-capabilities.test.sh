...
manifest_name="mayhem-0.2.23-x86_64-pc-windows-msvc.manifest.json"
...
publish_release_key_record \
  "$signature_path" \
  "$trusted_key_path" \
  "$tmp/mayhem-0.2.23-x86_64-pc-windows-msvc.release-key.json" \
  1700000000
cmp \
  "$trusted_key_path" \
  "$tmp/mayhem-0.2.23-x86_64-pc-windows-msvc.release-key.json" >/dev/null ||

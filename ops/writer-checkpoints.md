...
Core v0.2.174 introduced contract revision 22; v0.2.177 retains that contract. The peer reads checkpoint environment settings in both Node and Pear/Bare. Upgrade all participating peers before

...
`v0.2.59` is a source release. GitHub publishes the tagged source archives; it
...
`v0.2.59` is source-only. The GitHub release contains the tagged source, not
...
The `0.2.59` source release makes local builds self-consistent across macOS,

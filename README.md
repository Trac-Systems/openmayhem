...
`v0.2.177` refreshes provider admission prices from the confirmed ledger for
each new session. Price updates take effect without restarting models. Active
sessions retain their signed prices and receipts.
...
`v0.2.177` is a source release. GitHub publishes the tagged source archives; it
...
`v0.2.177` is source-only. The GitHub release contains the tagged source, not

...
`v0.2.60` is a source release. GitHub publishes the tagged source archives; it
...
`v0.2.60` is source-only. The GitHub release contains the tagged source, not
...
The `0.2.60` source release makes local builds self-consistent across macOS,

...
- `video.minimax_h3.spectrum`: signed dev catalog row and workflow-class
  ...
  media `896x512`, `24` fps, `5.167s`, H.264/AAC stereo. This is not
  product-accepted until owner review confirms a measurable speed/quality win
  over base H3.
...
- `video.lipsync`: InfiniteTalk remains rejected for product quality. LongCat
  ...
  audio. This closes the paid technical route proof; owner audio/speech quality
  review remains the final acceptance check before treating it as public product
  capacity.

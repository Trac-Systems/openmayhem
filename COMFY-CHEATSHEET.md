...
- `upscale.conv.le24mp`: signed standalone 4x convolutional upscaler policy
  ...
  It still needs a paid route proof before product-accepted live capacity.
...
| `upscale.conv.le24mp` | Standalone convolutional 4x upscale/restore up to 4096x4096 output | 4x-spanx4 `d871ba305a9cbe521c3da166f06d84b80db02a36a1b4e89720d6bddf54965e0a` | `comfyui-v0.30.1` | Catalog-admitted with embedded outcome-class policy and local reference admission proof; inventory root `e3939d8c9af52b8772faaa0c2570e27d3cb3f963001c09b8efe42f6e48f42c98`, required memory `4.81GiB`, graph SHA-256 `9a24896bfe8a78bcac41f7895126ad02593bde5bcabb9aec70229c7940d2f2a2`, retained reference artifact `openmayhem-upscale-conv-le24mp-reference-v0.2.127.png`, output SHA-256 `3b78c0ecd45cfa63c75d2eea18c7056c417015908c7ec7c8dddc327949e4f8fc`; paid route proof still pending. |

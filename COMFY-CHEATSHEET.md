...
- `upscale.diffusion`: signed dev SeedVR2 diffusion upscale/restore policy is
  ...
  The real-world paid-route proof is still pending buyer-wallet funding.
...
| `upscale.diffusion` | SeedVR2 3B int8 convrot has a signed dev policy, `.70` reference admission proof, and paid fiat route proof. A stronger real-world admission artifact exists, but its real-world paid-route proof is still pending funded buyer credit. Do not mix diffusion upscale into convolutional-upscale admission. | Active policy parts: `e2a27b04` SeedVR2 3B int8 convrot, `63e69083` SeedVR2 VAE. Older/restoration candidates: `9c98aed7` SeedVR2 3B fp8, `ca6bff3f` SeedVR2 7B fp8. Optional video preprocessing/interpolation support: `6cc88536` RIFE 4.7, `865582d1` RIFE 4.9. |

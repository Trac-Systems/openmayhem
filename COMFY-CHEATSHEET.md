...
- `video.minimax_h3.spectrum`: signed dev catalog row and workflow-class
  ...
  `openmayhem-minimax-h3-spectrum-reference-v0.2.129.mp4`. This is not
  product-accepted until a paid `/v1/workflows` proof shows a measurable
  speed/quality win over base H3.

...
pub use endpoint_contract::{
    ...
    ArtifactGenerationInlineAudioLoad, EndpointCalibrationCase, EndpointCalibrationMutation,
    EndpointCalibrationValue, EndpointContractViolation,
};
...
pub const CONTRACT_VERSION: u32 = 21;

...
.pg-controls{width:3.75rem;height:100%;min-height:0;border:1px solid rgba(229,231,235,.11);border-radius:1rem;background:linear-gradient(155deg,rgba(20,22,27,.985),rgba(14,15,19,.985));display:flex;overflow:hidden;box-shadow:inset 0 1px 0 rgba(255,255,255,.045),0 30px 76px -42px #000;transition:width .34s var(--pg-ease),border-color .2s ease}
.pg-controls.is-open{width:clamp(24rem,31vw,26rem);border-color:rgba(229,231,235,.14)}.pg-controls-backdrop{display:none}

  ...
  <div class="pg-experience">
    ...
    <aside class="pg-controls" data-playground-controls aria-label="Generation settings">
      ...
      <div class="pg-controls-body" id="playground-controls-body" data-playground-controls-body hidden>
        <header class="pg-controls-head"><div><span>Selected model</span><strong data-playground-controls-model>{default_model_name}</strong></div><span class="pg-controls-head-actions"><button type="button" data-playground-reset-model>Reset model</button><button type="button" data-playground-controls-close aria-label="Close generation settings">Close</button></span></header>
        <div class="pg-controls-scroll">
          ...
          <button class="pg-text-action pg-controls-reset-all" type="button" data-playground-reset-draft>Reset Playground draft and settings</button>
        </div>
      </div>
    </aside>
  </div>

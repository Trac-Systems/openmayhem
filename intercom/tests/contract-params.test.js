...
const EPOCH_OPERATING_PARAM_VALUES = {
  ...
  dispute_opener_fault_forfeit_bps: 2_500,
  dispute_timeout_epochs: 12,
  ...
  max_open_disputes_per_opener: 12,
  max_tap_settlement_outputs: 100,
  max_tnk_settlement_outputs: 100,
  max_fiat_settlement_outputs: 100,
  reservation_max_lifetime_epochs: 24,
...
test('MayhemContract setParams is admin-only and inert until the activation delay elapses', async () => {
  ...
  assert.deepEqual(defaults, {
    ...
    params: {
      ...
      max_fiat_settlement_outputs: 5_000,
      dispute_deposit_au: '1000000000000000000',
      dispute_timeout_epochs: 168,

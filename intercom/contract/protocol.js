...
class MayhemProtocol extends Protocol {
  ...
  async printOptions() {
    ...
    console.log('- Feature { "feature": "mayhem", "key": "hold/targeted/<rail>/<user>/<epoch>/<session_id>/<payload_hash>", "value": { "op": "spend_reserve_targeted", "contract_version": 13, "payout_revision": "<revision>", "session_id": "<id>", "epoch": 1, "rail": "fiat", "user": "<pk>", "provider": "<pk>", "enclave_id": "<id>", "price_ver": 1, "rules_ver": 1, "max_spend_au": "1000", "voucher": { ... }, "provider_sig": "<sig>" } } | provider reserves user balance against the exact active payout revision before serving.');
